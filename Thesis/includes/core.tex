...
Autonómne vozidla zaznamenali značnú investíciu ale aj kontrolu zo strany štátnych a nadnárodných organizácií. Spoločnosti, ktoré poskytujú služby samoriadiacich vozidiel rozširujú svoju dostupnosť, znižujú počet senzorov a náklady na hardvér. Hoci technológický pokrok napreduje, integrácia do infraštruktúry mesta zostáva podstatnou výzvou pre adopciu AV do dopravy. Štandard SAE International preto opisuje plán prechodu od asistencie šoférovania po plne autonómnu prevádzku~\cite{theguardian2026, waymo2026}.
\subsubsection{Umelá inteligencia}
\subsubsection{Senzory}
Kamery Majú široké spektrum využitia, od detekcie vzdialených prvkov po rozpoznávanie pruhov a dopravných značení
Radarové senzory sa delia podľa dosahu: radary na dlhý dosah sa používajú na detekciu vzdialených objektov aj , radary na krátky dosah sa používajú na prevenciu kolízie z boku a zo zadu
Kamery poskytujú vozidlu vizuálnu detekciu objektov na krátku až strednú vzdialenosť, čím simulujú funkciu ľudského oka. Radarové senzory sa používajú na detekciu vzdialených objektov, najmä v nepriaznivých podmienkach (hmla, dážď, prach). LiDAR na rozdiel od radaru je lepší v mapovaní trojrozmerných objektov, no je viac náchylný na poveternostné podmienky. Ultrazvukové senzory sa využívajú na meranie krátkych vzdialeností, napríklad pri parkovaní
