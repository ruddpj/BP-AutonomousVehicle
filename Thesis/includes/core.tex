...
K motorčekom sme prispájkovali káble, pripevnili kolesá a nalepili pásku na zvýšenie trenia. Celú sústavu pre obe strany sme následne zasunuli do vyhradených držiakov. Kameru a ultrazvukový senzor sme vložili do držiaku, ktorý sme pripevnili k vozidlu pomocou sťahovacích pások. Batériu a menič napätia sme spojili a zasunuli do vyhradenej prehradky.\par
Modifikovali sme aj USB-A kábel pridaním vypínača a koncovích hrotov; túto súčiastku sme zapojili do USB výstupu na meniči a do napájaciej koľajnice na nepájivom poli. Na záver sme do rámu vložili podpornú vidlicu, čím sme montáž vozidla skompletizovali.
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.15]{img/vozidlo1.jpg}
	\caption{Skompletizované vozidlo (predok)}
	\label{fig:vozidlo1}
\end{figure}
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.15]{img/vozidlo2.jpg}
...
Detekcia cesty slúži ako dôležitá súčasť autonómnych vozidiel. \acrshort{av} musia byť schopné sa udržať na rôznych typoch vozovky, za rozlišných svetelných podmienok. Systémy vnímania to dokážu pomocou kombinácie počítačového videnia a dát zo senzorov.
\subsubsection{Region of interest}
\subsubsection{Hľadanie svetlých regiónov}
