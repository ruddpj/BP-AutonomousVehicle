...
K batérii sme pripojili vypínač, na ovládanie toku elektriny. Batériu a menič napätia sme spojili a zasunuli do vyhradenej prehradky. Na záver sme do rámu vložili podpornú vidlicu, čím sme montáž vozidla skompletizovali.
\newpage
\begin{figure}[!ht]
	\centering
...
\begin{lstlisting}[language=Python, caption=Funkcia \acrshort{roi}]
