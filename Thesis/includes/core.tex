...
\begin{figure}[!ht]
	...
	\label{fig:model}
\end{figure}
Model bol vytlačený na tlačiarni Bambulab A1 mini, použitím filamentu kyseliny polymliečnej (PLA). Na kolesá vozidla sme zasa využili odolnejší polyetyléntereftálat modifikovaný glykolom (PETG).\par
...
K motorčekom sme prispájkovali káble, pripevnili kolesá a nalepili pásku na zvýšenie trenia. Celú sústavu pre obe strany sme následne zasunuli do vyhradených držiakov. Kameru a ultrazvukový senzor sme vložili do držiaku, ktorý sme pripevnili k vozidlu pomocou sťahovacích pások.\par
