...
K batérii sme pripojili vypínač, na ovládanie toku elektriny. Batériu a menič napätia sme spojili a zasunuli do vyhradenej prehradky. Na záver sme do rámu vložili podpornú vidlicu, čím sme montáž vozidla skompletizovali -- viď obrázok \ref{vozidlo1} a \ref{vozidlo2}.
\newpage
\begin{figure}[!ht]
	\centering
...
Pri našej implementácii sme použili ultrazvukový senzor na detekciu prekážok priamo pred vozidlom. Použitý HC-SR04 ultrazvukový senzor funguje ako vysielač, prijímač aj riadiaci obvod. Princíp merania vzdialenosti je nasledovný:
\begin{enumerate}
...
\end{enumerate}
Obrázok \ref{fig:ultrazvuk} ilustruje tento proces. 
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.12]{img/ultrazvuk.png}
